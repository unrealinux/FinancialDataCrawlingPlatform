...
func init() {
	Bohaiguojixt.Register()
}

var Bohaiguojixt = &Spider{
	Name:        "渤海国际信托",
	Description: "渤海国际信托净值数据 [Auto Page] [https://www.bohaitrust.com/Other/netvalue/cid/46/lid/47.html]",
	// Pausetime: 300,
	// Keyin:   KEYIN,
	// Limit:        LIMIT,
				...
				AidFunc: func(ctx *Context, aid map[string]interface{}) interface{} {
					...
					for loop := aid["loop"].([2]int); loop[0] < loop[1]; loop[0]++ {
						...
						ctx.AddQueue(&request.Request{
							Url:  "https://www.bohaitrust.com/Other/netvalue/cid/46/lid/47/p/" + strconv.Itoa(loop[0]) + ".html",
				...
				ParseFunc: func(ctx *Context) {
					...
					ss.Each(func(i int, goq *goquery.Selection) {
						...
						if titleLine != "产品名称" {
							...
							count++
							fundID := "XTBOHAIGUOJI" + "P1" + strconv.Itoa(page1) + "L" + strconv.Itoa(count)
