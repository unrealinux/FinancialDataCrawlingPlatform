...
var Xizhangxt = &Spider{
	Name:        "西藏信托",
	Description: "西藏信托净值数据 [Auto Page] [http://www.ttco.cn/ttco/page_networth]",
	// Pausetime: 300,
	// Keyin:   KEYIN,
	// Limit:        LIMIT,
				...
				ParseFunc: func(ctx *Context) {
					...
					page := 0
				 	...
				 	for i := 1; i < count + 1; i++{
						 page++
						 	ctx.AddQueue(&request.Request{
								Url:  "http://www.ttco.cn/ttco/page_networth?st=dd&netWorthPage.pageSize=10&netWorthPage.pageNum=" + strconv.Itoa(i),
								Rule: "获取结果",
