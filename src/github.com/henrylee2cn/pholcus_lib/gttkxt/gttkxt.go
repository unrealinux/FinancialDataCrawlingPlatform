...
var Gttkxt = &Spider{
	Name:        "国投泰康信托",
	Description: "国投泰康信托净值数据 [Auto Page] [http://www.sdictrust.com.cn/cn/cpzx/A0228index_1.htm]",
	// Pausetime: 300,
	// Keyin:   KEYIN,
	// Limit:        LIMIT,
				...
				AidFunc: func(ctx *Context, aid map[string]interface{}) interface{} {
					...
					for loop := aid["loop"].([2]int); loop[0] < loop[1]; loop[0]++ {
						...
						ctx.AddQueue(&request.Request{
							Url:  "http://www.sdictrust.com.cn/cn/cpzx/A0228index_" + strconv.Itoa(loop[0]) + ".htm",
				...
				ParseFunc: func(ctx *Context) {
					...
					ss.Each(func(i int, goq *goquery.Selection) {
						...
						if titleLine != "名称" {
							...
							count++
							fundID := "XTGUOTOUTAIKANG" + "P1" + strconv.Itoa(page1) + "L" + strconv.Itoa(count)
